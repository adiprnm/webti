            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('epeidnum') ? ' has-error' : '' }}">
                            <label for="epeidnum" class="col-md-4 control-label">NIP</label>

                            <div class="col-md-6">
                                <input id="epeidnum" type="epeidnum" class="form-control" name="epeidnum" value="{{ old('epeidnum') }}" required>

                                @if ($errors->has('epeidnum'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('epeidnum') }}</strong>
                                    </span>
                                @endif
                            </div>
                        </div>
