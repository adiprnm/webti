										...
										<li>
											<div class="slide-body" data-group="slide">
												...
												<div class="caption header" data-animate="slideAppearUpToDown" data-delay="500" data-length="300">
													<a href="/news_detail/{{ $hn->slug }}" style="color: white;"><button class="btn btn-primary"><h4>{{ $hn->title }}</h4></button></a>
													<a href="/news_detail/{{ $hn->slug }}" style="color: white;"><div class="caption-sub" data-animate="slideAppearDownToUp" data-delay="1200" data-length="300"><button class="btn btn-primary"><h6><span>Baca selengkapnya</span></h6></button></a></div>
												</div>
											</div>
										</li>
										@endforeach
